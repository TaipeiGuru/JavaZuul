...
class Game 
{
    ...
    private void printWelcome()
    {
        ...
        System.out.println("This is a castle with 19 rooms (20 if you include outside). Each room connects to at least one other room.");
        System.out.println("There are also 7 magic items spread throughout the castle.");
        System.out.println("To win, you must have all 7 magic items in your inventory and then go outside.");
        System.out.println("\nWarning: don't leave with the castle's keystone or the king's pet duckling!");
        System.out.println("If you leave with the keystone, the castle will crumble to ruins. If you leave with the duckling, the king will become furious and order you to be killed.");
